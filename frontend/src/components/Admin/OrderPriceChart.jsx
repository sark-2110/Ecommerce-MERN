    ...
    <Card className='mb-3 py-3 px-2 rounded text-center'>
      ...
      <ResponsiveContainer width='100%' height={350}>
        <BarChart data={orders} margin={{ top: 10, right: 30, left: 10, bottom: 10 }} >
          ...
          <Tooltip />
          <Legend />
          <Bar type='monotone'  dataKey='itemsPrice' fill='#7AC6E1' activeDot={{ r: 8 }} />
          <Bar type='monotone' dataKey='taxPrice' fill='#EB6F80' activeDot={{ r: 8 }} />
          <Bar type='monotone' dataKey='totalPrice' fill='#FFD949' activeDot={{ r: 8 }} />
        </BarChart>
      </ResponsiveContainer>
    </Card>
  );
